...
export interface TeamRecord {
  ...
  /**
   * Present on autogenerated teams; null on manually-created teams.
   * Records the generation parameters so the team can be regenerated or identified as autogen.
   */
  autogen?: { version: number; theme: string; parity: string; baseSeed: string } | null;
}
