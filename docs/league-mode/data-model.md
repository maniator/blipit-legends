...
const leaguesSchemaV1: RxJsonSchema<LeagueRecord> = {
  ...
  properties: {
    ...
    defaultSeasonPreset: {
      type: "string",
      enum: ["QUICK", "SHORT", "STANDARD", "FULL", "CUSTOM"],
      maxLength: 32,
    },
    ...
    status: { type: "string", enum: ["ACTIVE", "INACTIVE"], maxLength: 16 },
  },
  required: [
    "id",
    "schemaVersion",
...
const leagueSeasonsSchemaV1: RxJsonSchema<LeagueSeasonRecord> = {
  ...
  properties: {
    ...
    tradeDeadlineGameDay: { type: "number", minimum: 1, maximum: 999, multipleOf: 1 },
    currentGameDay: { type: "number", minimum: 1, maximum: 999, multipleOf: 1 },
...
const scheduledGamesSchemaV1: RxJsonSchema<ScheduledGameRecord> = {
  ...
  properties: {
    ...
    gameType: { type: "string", enum: ["REGULAR", "PLAYOFF"], maxLength: 16 },
    playoffRound: { type: "number", minimum: 1, maximum: 8, multipleOf: 1 },
    status: { type: "string", enum: ["PENDING", "COMPLETED", "CANCELLED"], maxLength: 16 },
...
const tradeRecordsSchemaV1: RxJsonSchema<TradeRecord> = {
  ...
  indexes: ["leagueSeasonId", ["leagueSeasonId", "createdAt"], ["leagueId", "createdAt"]],
};
```
