...
- **In agent/coding contexts** (tool access available): invoke the `bmad-code-review` skill first, then invoke `bmad-party-mode` to run a multi-persona deliberation on the findings. Both skills must be used together.
