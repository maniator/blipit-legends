...
| `@ux-design-lead`         | Cross-cutting redesign spanning ≥ 5 routes, full navigation overhaul, or accessibility-critical change | UX spec with mockups, heuristic findings, persona interview digests, WCAG 2.2 AA compliance notes | Design risk assessment + APPROVE / REQUEST_CHANGES                                                  |
...
| Net-new screen, modal, copy, design-system addition  | `@ux-design-lead`         |
